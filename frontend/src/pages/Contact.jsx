    ...
    <div className="contact-page bg-[linear-gradient(180deg,#071225,rgba(10,15,31,0.95))] min-h-screen text-white w-full">
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          <div className="glass rounded-2xl p-6 sm:p-8 border border-blue-500/10 animate-pop-scale animate-float lift-on-hover" style={{ animationDelay: '0.2s' }}>
            <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Send a Message</h2>
            <ContactForm />
          </div>
          
          <div className="glass rounded-2xl p-6 sm:p-8 border border-blue-500/10 resources-card animate-pop-bounce animate-sway lift-on-hover" style={{ animationDelay: '0.3s' }}>
            <ContactDownloads />
          </div>
        </div>
      </main>
